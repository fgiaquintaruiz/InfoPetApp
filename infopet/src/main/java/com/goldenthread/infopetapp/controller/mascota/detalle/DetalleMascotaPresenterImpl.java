...
public class DetalleMascotaPresenterImpl implements DetalleMascotaPresenter, OnFinishedListener {

    private DetalleMascotaView view;
    private Presenter presenter;

    public DetalleMascotaPresenterImpl(DetalleMascotaView view, Presenter presenter) {
        this.view = view;
