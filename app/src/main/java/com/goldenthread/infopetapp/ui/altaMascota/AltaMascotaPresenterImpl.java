...
public class AltaMascotaPresenterImpl implements AltaMascotaPresenter, OnFinishedListener {

    private AltaMascotaView view;
    private Presenter presenter;

    public AltaMascotaPresenterImpl(AltaMascotaView view, Presenter presenter) {
        this.view = view;
